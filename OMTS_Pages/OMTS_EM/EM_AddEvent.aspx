<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EM_AddEvent.aspx.cs" 
Inherits="fyp.EM_AddEvent" MasterPageFile="~/Site1.Master" Async="true" %>

<asp:Content ID="ContentTitle" ContentPlaceHolderID="title" runat="server">Add Event</asp:Content>
    ...
    <div class="container">
        ...
        <div class="main-content">
            <h2 class="page-header">
                <asp:Literal ID="litAddEvent" runat="server" Text="Add New Event" />
            </h2>
            ...
            <div class="form-container">
                ...
                <div class="btn-container">
                    <asp:Button ID="btnSaveEvent" runat="server" Text="Save Event" CssClass="btn-primary" OnClick="btnSaveEvent_Click" />
